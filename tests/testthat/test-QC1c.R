...
test_that("QC1c", {
              ...
              x <- QC1c(d_parameter = parameter, d_metingen = metingen)
              ...
              expect_equal(length(x_attr[["QC1c"]][["oordeel"]][["verdacht"]]), 0)
              ...
              x <- QC1c(d_parameter = d, d_metingen = metingen, verbose = FALSE)
              x_attr <- attr(x, "qcout")
              ...
              expect_true(length(x_attr[["QC1c"]][["oordeel"]][["verdacht"]])> 0)
